...
2. Create and use the database (retail_sales_db).
3. Import the dataset (CSV file).
4. Run SQL queries from the project file.
5. Analyze the results.
   
## Author - Sahil Khan

This project is part of my portfolio, showcasing my SQL skills for data analysis roles.
It demonstrates my ability to work with real-world datasets, perform data analysis, and extract meaningful insights using SQL.

This project is inspired by common SQL data analysis problems and enhanced with my own queries and understanding.
...
### Stay Updated 
- **LinkedIn**: [Connect with me professionally](https://www.linkedin.com/in/sahilkhan-data)
- This project highlights my problem-solving skills and practical understanding of SQL for real-world business scenarios.
